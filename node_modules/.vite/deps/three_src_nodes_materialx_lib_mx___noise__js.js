...
//#endregion
//#region node_modules/three/src/nodes/core/ArrayNode.js
/**
...
//#endregion
//#region node_modules/three/src/nodes/core/UniformGroupNode.js
/**
...
//#endregion
//#region node_modules/three/src/nodes/core/UniformNode.js
/**
...
//#endregion
//#region node_modules/three/src/nodes/core/AssignNode.js
/**
...
addMethodChaining("assign", /* @__PURE__ */ nodeProxy(AssignNode).setParameterLength(2));
//#endregion
//#region node_modules/three/src/nodes/code/FunctionCallNode.js
/**
...
//#endregion
//#region node_modules/three/src/nodes/math/ConditionalNode.js
/**
...
//#endregion
//#region node_modules/three/src/nodes/core/ContextNode.js
/**
...
//#endregion
//#region node_modules/three/src/nodes/core/VarNode.js
/**
...
//#endregion
//#region node_modules/three/src/nodes/core/SubBuildNode.js
/**
...
//#endregion
//#region node_modules/three/src/nodes/core/VaryingNode.js
/**
	...
	generate(builder) {
		...
		if (properties[propertyKey] === void 0) {
			...
			if (builder.shaderStage === NodeShaderStage.VERTEX) {
				...
				builder.addLineFlowCode(`${propertyName} = ${snippet}`, this);
			} else builder.flowNodeFromShaderStage(NodeShaderStage.VERTEX, properties.node, type, propertyName);
...
//#endregion
//#region node_modules/three/src/nodes/display/ColorSpaceFunctions.js
/**
...
//#endregion
//#region node_modules/three/src/nodes/display/ColorSpaceNode.js
...
//#endregion
//#region node_modules/three/src/nodes/accessors/ReferenceBaseNode.js
/**
...
//#endregion
//#region node_modules/three/src/nodes/accessors/RendererReferenceNode.js
/**
...
//#endregion
//#region node_modules/three/src/nodes/display/ToneMappingNode.js
/**
...
//#endregion
//#region node_modules/three/src/core/BufferAttribute.js
...
//#endregion
//#region node_modules/three/src/nodes/accessors/BufferAttributeNode.js
/**
	...
	*/
	generate(builder) {
		...
		if (builder.shaderStage === "vertex" || builder.shaderStage === "compute") {
			...
			output = varying(this, varyingName).build(builder, nodeType);
		}
		return output;
	}
	/**
...
//#endregion
//#region node_modules/three/src/nodes/core/IndexNode.js
/**
...
IndexNode.DRAW;
//#endregion
//#region node_modules/three/src/nodes/gpgpu/ComputeNode.js
/**
...
//#endregion
//#region node_modules/three/src/nodes/core/IsolateNode.js
/**
...
//#endregion
//#region node_modules/three/src/nodes/core/BypassNode.js
/**
...
addMethodChaining("bypass", /* @__PURE__ */ nodeProxy(BypassNode).setParameterLength(2));
//#endregion
//#region node_modules/three/src/nodes/utils/Remap.js
/**
...
//#endregion
//#region node_modules/three/src/nodes/code/ExpressionNode.js
/**
...
//#endregion
//#region node_modules/three/src/nodes/utils/Discard.js
/**
...
//#endregion
//#region node_modules/three/src/nodes/display/PremultiplyAlphaFunctions.js
/**
...
//#endregion
//#region node_modules/three/src/nodes/display/RenderOutputNode.js
/**
...
//#endregion
//#region node_modules/three/src/nodes/utils/DebugNode.js
...
//#endregion
//#region node_modules/three/src/renderers/common/InspectorBase.js
/**
...
//#endregion
//#region node_modules/three/src/nodes/core/InspectorNode.js
/**
...
//#endregion
//#region node_modules/three/src/nodes/utils/FunctionOverloadingNode.js
/**
...
//#endregion
//#region node_modules/three/src/nodes/utils/LoopNode.js
/**
...
//#endregion
//#region node_modules/three/src/nodes/materialx/lib/mx_noise.js
var mx_select = /*@__PURE__*/ Fn(([b_immutable, t_immutable, f_immutable]) => {
	const f = float(f_immutable).toVar();
	const t = float(t_immutable).toVar();
	return select(bool(b_immutable).toVar(), t, f).uniformFlow();
}).setLayout({
	name: "mx_select",
	type: "float",
	inputs: [
...
var mx_bilerp_0 = /*@__PURE__*/ Fn(([v0_immutable, v1_immutable, v2_immutable, v3_immutable, s_immutable, t_immutable]) => {
	const t = float(t_immutable).toVar();
...
var mx_bilerp_1 = /*@__PURE__*/ Fn(([v0_immutable, v1_immutable, v2_immutable, v3_immutable, s_immutable, t_immutable]) => {
	const t = float(t_immutable).toVar();
	const s = float(s_immutable).toVar();
...
var mx_trilerp_0 = /*@__PURE__*/ Fn(([v0_immutable, v1_immutable, v2_immutable, v3_immutable, v4_immutable, v5_immutable, v6_immutable, v7_immutable, s_immutable, t_immutable, r_immutable]) => {
...
var mx_trilerp_1 = /*@__PURE__*/ Fn(([v0_immutable, v1_immutable, v2_immutable, v3_immutable, v4_immutable, v5_immutable, v6_immutable, v7_immutable, s_immutable, t_immutable, r_immutable]) => {
	const r = float(r_immutable).toVar();
	const t = float(t_immutable).toVar();
	const s = float(s_immutable).toVar();
...
var mx_gradient_float_0 = /*@__PURE__*/ Fn(([hash_immutable, x_immutable, y_immutable]) => {
...
var mx_gradient_float_1 = /*@__PURE__*/ Fn(([hash_immutable, x_immutable, y_immutable, z_immutable]) => {
...
var mx_gradient_vec3_0 = /*@__PURE__*/ Fn(([hash_immutable, x_immutable, y_immutable]) => {
	const y = float(y_immutable).toVar();
	const x = float(x_immutable).toVar();
...
var mx_gradient_vec3_1 = /*@__PURE__*/ Fn(([hash_immutable, x_immutable, y_immutable, z_immutable]) => {
	const z = float(z_immutable).toVar();
	const y = float(y_immutable).toVar();
	const x = float(x_immutable).toVar();
	const hash = uvec3(hash_immutable).toVar();
...
var mx_gradient_scale2d_1 = /*@__PURE__*/ Fn(([v_immutable]) => {
...
var mx_gradient_scale3d_1 = /*@__PURE__*/ Fn(([v_immutable]) => {
...
var mx_hash_int_0 = /*@__PURE__*/ Fn(([x_immutable]) => {
...
var mx_hash_int_1 = /*@__PURE__*/ Fn(([x_immutable, y_immutable]) => {
...
var mx_hash_int_2 = /*@__PURE__*/ Fn(([x_immutable, y_immutable, z_immutable]) => {
...
var mx_hash_int_3 = /*@__PURE__*/ Fn(([x_immutable, y_immutable, z_immutable, xx_immutable]) => {
...
var mx_hash_int_4 = /*@__PURE__*/ Fn(([x_immutable, y_immutable, z_immutable, xx_immutable, yy_immutable]) => {
...
var mx_hash_vec3_0 = /*@__PURE__*/ Fn(([x_immutable, y_immutable]) => {
	const y = int(y_immutable).toVar();
...
var mx_hash_vec3_1 = /*@__PURE__*/ Fn(([x_immutable, y_immutable, z_immutable]) => {
	const z = int(z_immutable).toVar();
	const y = int(y_immutable).toVar();
...
var mx_perlin_noise_float_0 = /*@__PURE__*/ Fn(([p_immutable]) => {
...
var mx_perlin_noise_float_1 = /*@__PURE__*/ Fn(([p_immutable]) => {
...
var mx_perlin_noise_vec3_0 = /*@__PURE__*/ Fn(([p_immutable]) => {
	const p = vec2(p_immutable).toVar();
	const X = int().toVar(), Y = int().toVar();
	const fx = float(mx_floorfrac(p.x, X)).toVar();
	const fy = float(mx_floorfrac(p.y, Y)).toVar();
...
var mx_perlin_noise_vec3_1 = /*@__PURE__*/ Fn(([p_immutable]) => {
	const p = vec3(p_immutable).toVar();
	const X = int().toVar(), Y = int().toVar(), Z = int().toVar();
	const fx = float(mx_floorfrac(p.x, X)).toVar();
	const fy = float(mx_floorfrac(p.y, Y)).toVar();
...
var mx_cell_noise_float_0 = /*@__PURE__*/ Fn(([p_immutable]) => {
...
var mx_cell_noise_float_1 = /*@__PURE__*/ Fn(([p_immutable]) => {
	const p = vec2(p_immutable).toVar();
...
var mx_cell_noise_float_2 = /*@__PURE__*/ Fn(([p_immutable]) => {
	const p = vec3(p_immutable).toVar();
...
var mx_cell_noise_float_3 = /*@__PURE__*/ Fn(([p_immutable]) => {
...
var mx_cell_noise_float = /*@__PURE__*/ overloadingFn([
	mx_cell_noise_float_0,
	mx_cell_noise_float_1,
	mx_cell_noise_float_2,
	mx_cell_noise_float_3
]);
var mx_cell_noise_vec3_0 = /*@__PURE__*/ Fn(([p_immutable]) => {
...
var mx_cell_noise_vec3_1 = /*@__PURE__*/ Fn(([p_immutable]) => {
	const p = vec2(p_immutable).toVar();
...
var mx_cell_noise_vec3_2 = /*@__PURE__*/ Fn(([p_immutable]) => {
	const p = vec3(p_immutable).toVar();
	const ix = int(mx_floor(p.x)).toVar();
	const iy = int(mx_floor(p.y)).toVar();
...
var mx_cell_noise_vec3_3 = /*@__PURE__*/ Fn(([p_immutable]) => {
	const p = vec4(p_immutable).toVar();
	const ix = int(mx_floor(p.x)).toVar();
	const iy = int(mx_floor(p.y)).toVar();
	const iz = int(mx_floor(p.z)).toVar();
...
var mx_fractal_noise_float = /*@__PURE__*/ Fn(([p_immutable, octaves_immutable, lacunarity_immutable, diminish_immutable]) => {
...
var mx_fractal_noise_vec3 = /*@__PURE__*/ Fn(([p_immutable, octaves_immutable, lacunarity_immutable, diminish_immutable]) => {
	const diminish = float(diminish_immutable).toVar();
	const lacunarity = float(lacunarity_immutable).toVar();
	const octaves = int(octaves_immutable).toVar();
	const p = vec3(p_immutable).toVar();
...
var mx_fractal_noise_vec2 = /*@__PURE__*/ Fn(([p_immutable, octaves_immutable, lacunarity_immutable, diminish_immutable]) => {
	const diminish = float(diminish_immutable).toVar();
	const lacunarity = float(lacunarity_immutable).toVar();
	const octaves = int(octaves_immutable).toVar();
	const p = vec3(p_immutable).toVar();
...
var mx_fractal_noise_vec4 = /*@__PURE__*/ Fn(([p_immutable, octaves_immutable, lacunarity_immutable, diminish_immutable]) => {
	const diminish = float(diminish_immutable).toVar();
	const lacunarity = float(lacunarity_immutable).toVar();
	const octaves = int(octaves_immutable).toVar();
	const p = vec3(p_immutable).toVar();
	return vec4(vec3(mx_fractal_noise_vec3(p, octaves, lacunarity, diminish)).toVar(), float(mx_fractal_noise_float(p.add(vec3(int(19), int(193), int(17))), octaves, lacunarity, diminish)).toVar());
}).setLayout({
...
var mx_worley_distance_0 = /*@__PURE__*/ Fn(([p_immutable, x_immutable, y_immutable, xoff_immutable, yoff_immutable, jitter_immutable, metric_immutable]) => {
...
var mx_worley_distance_1 = /*@__PURE__*/ Fn(([p_immutable, x_immutable, y_immutable, z_immutable, xoff_immutable, yoff_immutable, zoff_immutable, jitter_immutable, metric_immutable]) => {
	const metric = int(metric_immutable).toVar();
	const jitter = float(jitter_immutable).toVar();
...
var mx_worley_noise_float_1 = /*@__PURE__*/ Fn(([p_immutable, jitter_immutable, metric_immutable]) => {
	const metric = int(metric_immutable).toVar();
	const jitter = float(jitter_immutable).toVar();
	const p = vec3(p_immutable).toVar();
	const X = int().toVar(), Y = int().toVar(), Z = int().toVar();
...
var mx_worley_noise_float = /*@__PURE__*/ overloadingFn([mx_worley_noise_float_0, mx_worley_noise_float_1]);
var mx_worley_noise_vec2_1 = /*@__PURE__*/ Fn(([p_immutable, jitter_immutable, metric_immutable]) => {
	const metric = int(metric_immutable).toVar();
	const jitter = float(jitter_immutable).toVar();
	const p = vec3(p_immutable).toVar();
	const X = int().toVar(), Y = int().toVar(), Z = int().toVar();
...
var mx_worley_noise_vec2 = /*@__PURE__*/ overloadingFn([mx_worley_noise_vec2_0, mx_worley_noise_vec2_1]);
var mx_worley_noise_vec3_1 = /*@__PURE__*/ Fn(([p_immutable, jitter_immutable, metric_immutable]) => {
	const metric = int(metric_immutable).toVar();
	const jitter = float(jitter_immutable).toVar();
	const p = vec3(p_immutable).toVar();
	const X = int().toVar(), Y = int().toVar(), Z = int().toVar();
...
var mx_worley_noise_vec3 = /*@__PURE__*/ overloadingFn([mx_worley_noise_vec3_0, mx_worley_noise_vec3_1]);
var mx_unifiednoise2d = /*@__PURE__*/ Fn(([noiseType_immutable, texcoord_immutable, freq_immutable, offset_immutable, jitter_immutable, outmin_immutable, outmax_immutable, clampoutput_immutable, octaves_immutable, lacunarity_immutable, diminish_immutable]) => {
...
var mx_unifiednoise3d = /*@__PURE__*/ Fn(([noiseType_immutable, position_immutable, freq_immutable, offset_immutable, jitter_immutable, outmin_immutable, outmax_immutable, clampoutput_immutable, octaves_immutable, lacunarity_immutable, diminish_immutable]) => {
	const noiseType = int(noiseType_immutable).toVar();
...
//#endregion
export { mx_bilerp, mx_bilerp_0, mx_bilerp_1, mx_bits_to_01, mx_bjfinal, mx_bjmix, mx_cell_noise_float, mx_cell_noise_float_0, mx_cell_noise_float_1, mx_cell_noise_float_2, mx_cell_noise_float_3, mx_cell_noise_vec3, mx_cell_noise_vec3_0, mx_cell_noise_vec3_1, mx_cell_noise_vec3_2, mx_cell_noise_vec3_3, mx_fade, mx_floor, mx_floorfrac, mx_fractal_noise_float, mx_fractal_noise_vec2, mx_fractal_noise_vec3, mx_fractal_noise_vec4, mx_gradient_float, mx_gradient_float_0, mx_gradient_float_1, mx_gradient_scale2d, mx_gradient_scale2d_0, mx_gradient_scale2d_1, mx_gradient_scale3d, mx_gradient_scale3d_0, mx_gradient_scale3d_1, mx_gradient_vec3, mx_gradient_vec3_0, mx_gradient_vec3_1, mx_hash_int, mx_hash_int_0, mx_hash_int_1, mx_hash_int_2, mx_hash_int_3, mx_hash_int_4, mx_hash_vec3, mx_hash_vec3_0, mx_hash_vec3_1, mx_negate_if, mx_perlin_noise_float, mx_perlin_noise_float_0, mx_perlin_noise_float_1, mx_perlin_noise_vec3, mx_perlin_noise_vec3_0, mx_perlin_noise_vec3_1, mx_rotl32, mx_select, mx_trilerp, mx_trilerp_0, mx_trilerp_1, mx_unifiednoise2d, mx_unifiednoise3d, mx_worley_distance, mx_worley_distance_0, mx_worley_distance_1, mx_worley_noise_float, mx_worley_noise_float_0, mx_worley_noise_float_1, mx_worley_noise_vec2, mx_worley_noise_vec2_0, mx_worley_noise_vec2_1, mx_worley_noise_vec3, mx_worley_noise_vec3_0, mx_worley_noise_vec3_1 };
